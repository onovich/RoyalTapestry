...
export const TEXT = {
  en: {
    ...
    hintMove: 'Try dragging {card} to {target}. Estimated +{delta} pts.',
    hintSetup: 'Try placing {card} at {target} to build toward a scoring line.',
    hintNoMove: 'No useful hint yet. Place more cards and try again.',
  ...
  zh: {
    ...
    hintMove: '试试把 {card} 拖到{target}，预计 +{delta} 分。',
    hintSetup: '试试先把 {card} 放到{target}，为后续组合铺位。',
    hintNoMove: '暂时没有明显提示，先多放几张牌再试。',
    cellName: '第 {row} 行第 {column} 列',
